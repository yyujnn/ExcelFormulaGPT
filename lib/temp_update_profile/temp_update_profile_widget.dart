...
import 'temp_update_profile_model.dart';
export 'temp_update_profile_model.dart';

class TempUpdateProfileWidget extends StatefulWidget {
  const TempUpdateProfileWidget({super.key});

  static String routeName = 'temp_updateProfile';
  static String routePath = '/tempUpdateProfile';

  @override
  State<TempUpdateProfileWidget> createState() =>
      _TempUpdateProfileWidgetState();
}

class _TempUpdateProfileWidgetState extends State<TempUpdateProfileWidget> {
  late TempUpdateProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TempUpdateProfileModel());
