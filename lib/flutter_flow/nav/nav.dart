...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: TempAccountWidget.routeName,
          path: TempAccountWidget.routePath,
          builder: (context, params) => TempAccountWidget(),
        ),
        FFRoute(
          name: TempUpdateProfileWidget.routeName,
          path: TempUpdateProfileWidget.routePath,
          builder: (context, params) => TempUpdateProfileWidget(),
        ),
        FFRoute(
